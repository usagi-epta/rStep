...
/**
 * Signals that a connection exception has occurred on an RStep instance.
 *
 * @author  Jean-Louis Paquelin
 */
@SuppressWarnings("serial")
public class ConnectionException extends RStepException {

    /**
     * Constructs an {@code ConnectionException} with the specified detail message.
     *
     * @param message
    ...
    /**
     * Constructs an {@code ConnectionException} with the specified cause and a
